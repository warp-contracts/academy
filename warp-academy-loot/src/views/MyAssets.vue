<template>
  <div>
    <div class="notification warning">
      ...
      <a
        :href="`${url.sonar}/#/app/contract/${deployedContracts.loot}#state`"
        target="_blank"
        >latest and correct state in our Sonar</a
      >
    </div>
    ...
    <div v-if="sent" class="tx-sending notification">
      ...
      <a
        :href="`${url.sonar}/#/app/contract/${deployedContracts.loot}`"
        target="_blank"
      >
        Sonar
      </a>
    ...
    <div class="transactions" v-if="walletLoaded && address && !loadingAssets">
      ...
      >
        <div class="transaction-id">
          <a
            target="_blank"
            :href="`${url.sonar}/#/app/interaction/${transaction.id}`"
          >
            {{ transaction.id }}
          </a>
        </div>
